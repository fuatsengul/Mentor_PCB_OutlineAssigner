  ...
  using cInt = Int32;
    ...
    public const cInt hiRange = 0x7FFF;
      ...
      if (!Closed && polyType == PolyType.ptClip)
        ...
        {
            //swap horizontal edges' top and bottom _f1's so they follow the natural
    ...
    public class Clipper : ClipperBase
    {
      ...
      //------------------------------------------------------------------------------
        ...
        private static double DistanceFromLineSqrd(IntPoint pt, IntPoint ln1, IntPoint ln2)
        {
            ...
            //given 2 points (_f1¹,_f2¹) & (_f1²,_f2²) is ...
            //(_f2¹ - _f2²)_f1 + (_f1² - _f1¹)_f2 + (_f2² - _f2¹)_f1¹ - (_f1² - _f1¹)_f2¹ = 0
            //A = (_f2¹ - _f2²); B = (_f1² - _f1¹); C = (_f2² - _f2¹)_f1¹ - (_f1² - _f1¹)_f2¹
            //perpendicular distance of point (_f1³,_f2³) = (Ax³ + By³ + C)/Sqrt(A² + B²)
        ...
        public static Path CleanPolygon(Path path, double distance = 1.415)
        {
            ...
            //both _f1 & _f2 coords within 1 unit, then the second vertex will be stripped.
